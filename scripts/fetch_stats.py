...
AGENT_NAMES = {
    ...
    "buffer": "LinkedIn (Buffer)", "buffertiktok": "TikTok (Buffer)", "telegrampoll": "Telegram Polls", "emaildrip": "Email Drip", "buffercarousel": "LinkedIn Carousels", "blueskyfeed": "Bluesky Feed",
}
