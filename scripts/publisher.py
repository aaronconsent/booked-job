...
def ramp_daily_cap(age_days):
    ...
    return 3  # lowered 2026-07-08: Meta app rate-limit was tripping on the higher volume;
              # 3 FB text/day + reels/video/carousels keeps FB active but under the app limit
